...
class AttendancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attendance" do
    assert_difference('Attendance.count') do
      post attendances_url, params: { attendance: { started_at: @attendance.started_at, work_date: @attendance.work_date } }
    end
  ...
  test "should update attendance" do
    patch attendance_url(@attendance), params: { attendance: { started_at: @attendance.started_at, work_date: @attendance.work_date } }
